...
def scan_packet(packet, rules=IDS_RULES):
    ...
    A rule fires only if BOTH the protocol/port match AND the
    content pattern is found (case-insensitive).
    """
    alerts = []
...
<img width="1192" height="785" alt="image" src="https://github.com/user-attachments/assets/e5dc4a06-4d0c-4530-a327-0a73551bb219" />
